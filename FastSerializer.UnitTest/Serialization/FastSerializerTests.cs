...
// ReSharper restore ConditionIsAlwaysTrueOrFalse
		...
		public void CheckInt16OptimizedAsMinusOne()
		{
			Int16 value = -1;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInt32OptimizedAsMinusOne()
		{
			var value = -1;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckUInt16OptimizedLarge()
		{
			UInt16 value = UInt16.MaxValue - 1;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckUInt32OptimizedLarge()
		{
			var value = UInt32.MaxValue - 1;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckTimeSpanOptimizedMinValue()
		{
			var value = TimeSpan.MinValue;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckTimeSpanOptimizedMaxValue()
		{
			var value = TimeSpan.MaxValue;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckTimeSpanOptimizedTicksOnly()
		{
			var value = TimeSpan.FromTicks(59);
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckArrayListOptimizedNull()
		{
			ArrayList value = null;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInt16OptimizedTooLowMin()
		{
			var value = Int16.MinValue;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInt16OptimizedTooLow()
		{
			Int16 value = -1;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInt16OptimizedTooHigh()
		{
			var value = SerializationWriter.OptimizationFailure16BitValue;
			Writer.WriteOptimized(value);
		}

		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInt16OptimizedTooHighMax()
		{
			var value = Int16.MaxValue;
			Writer.WriteOptimized(value);
		}
		...
		{
			var value = SerializationWriter.OptimizationFailure32BitValue;
			Writer.WriteOptimized(value);
		}
		...
		{
			var value = SerializationWriter.OptimizationFailure64BitValue;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckUInt16OptimizedTooHigh()
		{
			var value = (ushort) SerializationWriter.OptimizationFailure16BitValue;
			Writer.WriteOptimized(value);
		}

		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckUInt16OptimizedTooHighMax()
		{
			var value = UInt16.MaxValue;
			Writer.WriteOptimized(value);
		}
		...
		{
			UInt32 value = SerializationWriter.OptimizationFailure32BitValue;
			Writer.WriteOptimized(value);
		}
		...
		{
			UInt64 value = SerializationWriter.OptimizationFailure64BitValue;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckCustomClassArrayOptimizedNull()
		{
			CustomClass[] value = null;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(ArrayTypeMismatchException))]
		public void CheckCustomClassArrayOptimizedMixedWrongElementType()
		{
			var value = new[] { new CustomClass(), null, new InheritedCustomClass() };
			value[0].IntValue = 5;
			value[0].StringValue = "abc";
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckInheritedCustomClassArrayOptimizedNull()
		{
			InheritedCustomClass[] value = null;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckSemiIntelligentCustomClassArrayOptimizedNull()
		{
			SemiIntelligentCustomClass[] value = null;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(ArrayTypeMismatchException))]
		public void CheckSemiIntelligentCustomClassArrayOptimizedMixedWrongElementType()
		{
			var value = new[] { new SemiIntelligentCustomClass(), null, new InheritedSemiIntelligentCustomClass() };
			value[0].IntValue = 5;
			value[0].StringValue = "abc";
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckIntelligentCustomClassArrayOptimizedNull()
		{
			IntelligentCustomClass[] value = null;
			Writer.WriteOptimized(value);
		}
		...
		[Test, ExpectedException(typeof(ArrayTypeMismatchException))]
		public void CheckIntelligentCustomClassArrayOptimizedMixedWrongElementType()
		{
			var value = new[] { new IntelligentCustomClass(), null, new InheritedIntelligentCustomClass() };
			value[0].IntValue = 5;
			value[0].StringValue = "abc";
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckStringArrayOptimizedNull()
		{
			string[] value = null;
			Writer.WriteOptimized(value);
		}
...
// ReSharper restore AssignNullToNotNullAttribute
		...
		[Test, ExpectedException(typeof(InvalidOperationException))]
		public void CheckBitArrayOptimizedNull()
		{
			BitArray value = null;
			Writer.WriteOptimized(value);
		}
		...
		public void CheckNullSerializationWriterStream()
		{
			new SerializationWriter(null);
		}

		[Test, ExpectedException(typeof(ArgumentException))]
		public void CheckNonWriteableSerializationWriterStream()
		{
			new SerializationWriter(new MemoryStream(new byte[10], false));
		}

		[Test, ExpectedException(typeof(ArgumentNullException))]
		public void CheckNullSerializationReaderStream()
		{
			new SerializationReader((Stream) null);
		}

		[Test, ExpectedException(typeof(ArgumentException))]
		public void CheckNonReadableSerializationReaderStream()
		{
			var memoryStream = new MemoryStream();
			memoryStream.Close();
			
			new SerializationReader(memoryStream);
		}
